package com.fireinrain.xjavbus.entity;
...
public class StarInfoEntity {
    ...
    public String toString() {
        return "JavbusStarInfoItem{" + "allFilmNum='" + allFilmNum + '\'' + ", hasMagNum='" + hasMagNum + '\'' + ", headPhoto='" + headPhoto + '\'' + ", starName='" + starName + '\'' + ", birthday='" + birthday + '\'' + ", age='" + age + '\'' + ", height='" + height + '\'' + ", cup='" + cup + '\'' + ", chestCircumference='" + chestCircumference + '\'' + ", waistline='" + waistline + '\'' + ", hips='" + hips + '\'' + ", birthPlace='" + birthPlace + '\'' + ", hobby='" + hobby + '\'' + '}';
    }
}
